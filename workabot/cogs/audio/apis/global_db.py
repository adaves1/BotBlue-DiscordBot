...
from workabot.core import Config
from worka.core.bot import Worka
from worka.core.commands import Cog
from worka.core.i18n import Translator
...
_API_URL = "https://api.workabot.app/"    # Damn the domain was expensive
_ = Translator("Audio", Path(__file__))
log = getLogger("worka.cogs.Audio.api.GlobalDB")


class GlobalCacheWrapper:
    def __init__(
        self, bot: Worka, config: Config, session: aiohttp.ClientSession, cog: Union["Audio", Cog]
    ):
