...
import discord
from workabot.core import Config, commands
from workabot.core.i18n import Translator, cog_i18n
from workabot.core.utils.chat_formatting import box
from workabot.core.utils.mod import get_audit_reason
from workabot.core.utils.predicates import MessagePredicate

from .announcer import Announcer
from .converters import SelfRole

log = logging.getLogger("worka.admin")
...
class Admin(commands.Cog):
    ...
    async def worka_delete_data_for_user(self, **kwargs):
        """Nothing to delete"""
        return
