...
AUDIO_FOLDER = ROOT_FOLDER / "workabot/cogs/audio"

# We want to import `workabot.cogs.audio.managed_node` package as if it were top-level package
# so we have to the `workabot/cogs/audio` directory to Python's path.
